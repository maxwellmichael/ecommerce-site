...
const Footer = ()=>{
    ...
    return(
        <Grid style={{margin:'100px 0px 0px 0px', padding:'0px 0px 20px 0px',overflow:'hidden'}} container>
            ...
            <Grid style={{borderTop:'1px solid black', width:'100vw'}} container spacing={1}>
